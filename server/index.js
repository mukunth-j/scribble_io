...
const DB = 'mongodb+srv://scribbout:iLd7bCv7sO72P4zX@cluster0.qhncvhw.mongodb.net/?retryWrites=true&w=majority';
...
io.on('connection',(socket) => {
    ...
    socket.on('create-game',async({nickname,name,occupancy,maxRounds}) => {
        try{
            ...
            if(existingRoom){
                socket.emit('notCorrectGame', "Room with that name aldready exists !");
                return;
            }
            let room = new Room();
            const word = getWord();
